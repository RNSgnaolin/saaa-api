...
class AircraftControllerTest {
    ...
    void testRegisterAircraft2() throws Exception {
        ...
        var data = new AircraftDTO("Brand", "Model", "N156AC", Classification.GOVERNMENT, 1l);
        var personData = new Person(1l, "John Doe", "John Doe", 7518l);
        var aircraftData = new Aircraft(1l, "Brand", "Model", "N156AC", Classification.GOVERNMENT, personData);

        var expectedJson = aircraftListingJson.write(
            new AircraftListingDTO("Brand", "Model", "GOVERNMENT", "N156AC", "John Doe", true)
        ).getJson();
    ...
    void testInvalidTailNumbers() throws Exception {
        ...
        List<Aircraft> aircrafts = Arrays.asList(
            new Aircraft(1l, "Brand1", "Model1", "AIR 1", Classification.GOVERNMENT, person),
            new Aircraft(2l, "Brand2", "Model2", "N156AC", Classification.GOVERNMENT, person),
            new Aircraft(3l, "Brand3", "Model3", "N12345", Classification.GOVERNMENT, person),
            new Aircraft(4l, "Brand4", "Model4", "N15ABC", Classification.GOVERNMENT, person),
            new Aircraft(5l, "Brand5", "Model5", "N156IB", Classification.GOVERNMENT, person),
            new Aircraft(6l, "Brand6", "Model6", "N156OC", Classification.GOVERNMENT, person)
        );
